...
<link rel="stylesheet" href="main.css">
			<div class="header">
				<ul>
					<li style="float:left;border-right:none"><a href="cover.php" class="logo"><img src="images/cal.png" width="30px" height="30px"><strong> DABS </strong>Doctor Appointment Booking System</a></li>
					<li><a href="locateus.php">About Me</a></li>
					<li><a href="#home">Home</a></li>
				</ul>
			</div>
			<div class="center">
				<h1>DABS</h1><br>
				<p style="text-align:center;color:black;font-size:30px;top:35%">Doctor Appointment Booking System</p><br>
