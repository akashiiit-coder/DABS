...
<body style="background-image:url(images/p2.jpg)">
	<div class="header">
		<ul>
			<li style="float:left;border-right:none"><a href="ulogin.php" class="logo"><img src="images/cal.png" width="30px" height="30px"><strong> DABS </strong>Doctor Appointment Booking System</a></li>
	...
	<div class="sucontainer" style="background-image:url(images/yellowpage.jpg)">
		<ul style="background-image:url(images/yellowpage.jpg)">
			<center>
			<label><b><h2>Developer</h2></b></label>
				<img src="user.jpg" alt="Akash Anand" height = 250px>
				<h2> Akash Anand</h2>
				<h2> 11912051</h2>
				<h2> Information Technology</h2>
				<h2> Indian Institute of Information Technology, Sonepat</h2>
				<h2> Group - 201</h2>
